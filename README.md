...
## Purpose
The artifact has been made publicly accessible on ([GitHub](https://github.com/SmitPatel910/orca)), providing well-documented source code, experiment replication instructions, and all relevant data and outputs. We are claiming the **Available**, **Functional**, and **Reusable** badges. 
